...
public class FilterInvoiceKop extends Filter {
    private AdapterInvoiceKop adapterInvoiceKop;
    private ArrayList<ModelInvoiceKop> filterList;

    public FilterInvoiceKop(AdapterInvoiceKop adapterInvoiceKop, ArrayList<ModelInvoiceKop> filterList) {
        this.adapterInvoiceKop = adapterInvoiceKop;
    ...
    protected FilterResults performFiltering(CharSequence constraint) {
        ...
        if (constraint !=null && constraint.length()>0){
            ...
            ArrayList<ModelInvoiceKop> filteredModels = new ArrayList<>();
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        adapterInvoiceKop.invoiceKops = (ArrayList<ModelInvoiceKop>)  results.values;
        //refersh adapter
        adapterInvoiceKop.notifyDataSetChanged();
