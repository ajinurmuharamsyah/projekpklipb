...
public class GantiPeternakActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ganti_peternak);
    ...
    private void saverFirebase() {
        ...
        ref.child(mAuth.getUid()).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(GantiPeternakActivity.this, "Gagal Update...", Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            public void onComplete(@NonNull Task<Void> task) {
                user.updateEmail(getEmail).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(GantiPeternakActivity.this, "Email updated...", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent (GantiPeternakActivity.this,SettingKoperasiActivity.class);
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(GantiPeternakActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }).addOnFailureListener(new OnFailureListener() {
    ...
    public void onBackPressed() {
        Intent intent = new Intent (GantiPeternakActivity.this,SettingPeternakActivity.class);
        startActivity(intent);
        finish();
    }
