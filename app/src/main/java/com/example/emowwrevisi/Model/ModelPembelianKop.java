...
public class ModelPembelianKop {
    private String pembayaranId,tanggal,namapeternak,namakoperasi,parameterBarang,jumlah,satuan,harga,total,uid;

    public ModelPembelianKop(String pembayaranId, String tanggal, String namapeternak, String namakoperasi, String parameterBarang, String jumlah, String satuan, String harga, String total, String uid) {
