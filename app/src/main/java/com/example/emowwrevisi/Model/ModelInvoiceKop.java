...
public class ModelInvoiceKop {
    private String invoiceId,totalkualitas,namakoperasi,namapeternak,tanggal,totalpembelian,totalsetoran,uid,totalpendapatan;

    public ModelInvoiceKop(String invoiceId, String totalkualitas, String namakoperasi, String namapeternak, String tanggal, String totalpembelian, String totalsetoran, String uid, String totalpendapatan) {
