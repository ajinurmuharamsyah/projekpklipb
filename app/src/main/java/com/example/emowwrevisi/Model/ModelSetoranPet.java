...
public class ModelSetoranPet {
    private String setoranId,uid,tanggal,namapeternak,namakoperasi,jamsetoran,hargaSusu,jumlahSusu,total;

    public ModelSetoranPet(String setoranId, String uid, String tanggal, String namapeternak, String namakoperasi, String jamsetoran, String hargaSusu, String jumlahSusu, String total) {
